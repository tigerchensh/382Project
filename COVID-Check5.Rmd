...
```{r}
plot(case_date$date,c(0,diff(case_date$n)),xlab="Case report date to CDC (0 as first date 2020-01-01)",ylab="Change of Covid cases number per day", main=" Change of Covid cases number in the U.S. and CDC report date", type = "l")
```
