...
```{r}
plot(case_date$date,case_date$n,xlab="Case report date to CDC (0 as first date 2020-01-01)",ylab="Covid case number", main="Covid case number in the U.S. and CDC report date")
```


```{r}
plot(case_date$date,c(0,diff(case_date$n)),xlab="Case report date to CDC (0 as first date 2020-01-01)",ylab="Change of Covid case number per day", main=" Change of Covid case number in the U.S. and CDC report date")
```
